package jwt.demo.web.rest;

import jwt.demo.config.Constants;
import jwt.demo.JhipsterJwtApplicationApp;
import jwt.demo.domain.Authority;
import jwt.demo.domain.User;
import jwt.demo.repository.AuthorityRepository;
import jwt.demo.repository.UserRepository;
import jwt.demo.security.AuthoritiesConstants;
import jwt.demo.service.MailService;
import jwt.demo.service.dto.UserDTO;
import jwt.demo.web.rest.errors.ExceptionTranslator;
import jwt.demo.web.rest.vm.KeyAndPasswordVM;
import jwt.demo.web.rest.vm.ManagedUserVM;
import jwt.demo.service.UserService;
...
@SpringBootTest(classes = JhipsterJwtApplicationApp.class)
